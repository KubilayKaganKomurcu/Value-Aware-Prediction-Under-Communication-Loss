...
class PPOLearner:
    def __init__(self, mac, scheme, logger, args):
        ...
        # Inside src/learners/ppo_learner.py -> __init__
        '''print(f"DEBUG: Agent Parameters Address: {id(self.agent_params)}")
        print(f"DEBUG: Critic Parameters Address: {id(self.critic_params)}")
        print ("***********************************************")
        print ("***********************************************")
        print ("***********************************************")
        i=0'''
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        if rewards.shape[-1] == 1:
            print("VERDICT: GLOBAL REWARD (Shared)")
        else:
            print("VERDICT: SEPARATE REWARDS (Agent-Specific)")
        print("="*30)'''
        ...
        #time.sleep(30) # Pausing to read the output
        ...
        for k in range(self.args.epochs):
            ...
            # advantages: [batch, time, agents] -- one per-agent learning signal,
            # returned at the end of train() so the predictor can reuse it as
            # sample weights in Value-Aware MARO.
